const CACHE_NAME = 'morandi-ai-v19';
const ASSETS_TO_CACHE = [
  ...
  '/js/runtime/multimodal-runtime.js',
  ...
  '/js/core/trace-center.js',
  '/js/core/api-scheduler.js',
  '/js/core/error-boundary.js',
  '/js/memory/embedding-cache.js',
  '/js/message/message-types.js',
  '/js/message/message-adapter.js',
  '/js/services/gemini-multimodal.js',
  '/emotions/angry.webp',
